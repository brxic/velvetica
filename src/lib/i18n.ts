...
export const messages = {
  de: {
    ...
    planning: 'Route wird geplant …', noStart: 'Setze zuerst einen Startpunkt auf der Karte.',
  ...
  en: {
    ...
    planning: 'Planning route …', noStart: 'First choose a starting point on the map.',
